...
CREATE TABLE `site` (
  ...
  `switch_one` tinyint(1) NOT NULL DEFAULT '0' COMMENT '',
  `switch_two` tinyint(1) NOT NULL DEFAULT '0' COMMENT '',
  `switch_three` tinyint(1) NOT NULL DEFAULT '0' COMMENT '',
  `switch_four` tinyint(1) NOT NULL DEFAULT '0' COMMENT '',
  `switch_five` tinyint(1) NOT NULL DEFAULT '0'COMMENT '',
  `switch_six` tinyint(1) NOT NULL DEFAULT '0' COMMENT '',
  `switch_seven` tinyint(1) NOT NULL DEFAULT '0' COMMENT '',
  `switch_eight` tinyint(1) NOT NULL DEFAULT '0' COMMENT '',
  `switch_nine` tinyint(1) NOT NULL DEFAULT '0' COMMENT '',
  `switch_ten` tinyint(1) NOT NULL DEFAULT '0' COMMENT '',
  `switch_eleven` tinyint(1) NOT NULL DEFAULT '0' COMMENT '',
